...
export class AddDwWModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { abt_dw_ws: [], imagesrc: process.env.REACT_APP_PHOTOPATH + this.abt_dw_w_img};
    ...
    abt_dw_w_img = "insert_analysis.jpg";
    imagesrc = process.env.REACT_APP_PHOTOPATH + this.abt_dw_w_img;
    ...
    handleSubmit(event) {
        ...
        fetch(process.env.REACT_APP_API + 'about-dw-w', {
            ...
            body: JSON.stringify({
                ...
                Abt_Dw_W_Img: this.abt_dw_w_img,
        ...
        return (
            ...
            >
                <Modal.Header closeButton>
                    ...
                    Add Data related to Crime Against Women
                    </Modal.Title>
