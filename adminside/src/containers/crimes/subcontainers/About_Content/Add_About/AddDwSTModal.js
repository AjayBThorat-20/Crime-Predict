...
export class AddDwSTModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { abt_dw_sts: [], imagesrc: process.env.REACT_APP_PHOTOPATH + this.abt_dw_st_img  };
    ...
    abt_dw_st_img = "insert_analysis.jpg";
    imagesrc = process.env.REACT_APP_PHOTOPATH + this.abt_dw_st_img;
    ...
    handleSubmit(event) {
        ...
        fetch(process.env.REACT_APP_API + 'about-dw-st', {
            ...
            body: JSON.stringify({
                ...
                Abt_Dw_ST_Img: this.abt_dw_st_img,
        ...
        return (
            ...
            >
                <Modal.Header closeButton>
                    ...
                    Add Data related to Crime Against ST
                    </Modal.Title>
